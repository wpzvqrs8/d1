...
# ----- CONFIG -----
GITHUB_USER = "wpzvqrs8"
GITHUB_REPO = "java_pro"
BRANCH = "main"

# Token from Streamlit secrets
TOKEN = st.secrets["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"]
...
def get_java_files():
    ...
    if 'tree' not in data:
        ...
        return []
    return [item['path'] for item in data['tree'] if item['path'].endswith(".java")]
